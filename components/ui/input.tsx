...
function Input({ className, type, value, defaultValue, ...props }: React.ComponentProps<"input">) {
  // Base UI's FieldControl requires a consistent controlled/uncontrolled contract.
  // If `value` is explicitly passed (controlled mode), keep it.
  // If not, use `defaultValue` for uncontrolled mode.
